...
public class OrderVO {
	...
	public int getOmaileage() {
		return omaileage;
	}

	public void setOmaileage(int omaileage) {
		this.omaileage = omaileage;
	}
	...
	public String toString() {
		return "OrderVO [onum=" + onum + ", idx_fk=" + idx_fk + ", ototalPrice=" + ototalPrice + ", ototalPoint="
				...
				+ opayWay + ", opayState=" + opayState + ", orderDate=" + orderDate + ", omileage=" + omaileage
