...
<h1 class="text-primary text-center">${loginUser.name}[${loginUser.userid }]님의 주문정보</h1>
...
<table class="table table-responsive">
   ...
   <tr bgcolor="#efefef" align="center">
      ...
      <tr>
        ...
        ${prod.pname}
        <br>
         <a href="../prodDetail?pnum=${prod.pnum}" target="_blank">
         <img src="../product_images/${prod.pimage1}"
            width="100" height="100" border="0" />
         </a>
         </td>
         <td align="right" style="padding-right:20px">
            <fmt:formatNumber value="${prod.saleprice}" pattern="###,###"/><br>
            [${prod.point}] POINT
         </td>
         <td align="center">
         ${prod.pqty}
         ...
         <td  align="right" style="padding-right:20px">
         <b>
         <fmt:formatNumber value="${prod.totalPrice}" pattern="###,###" />
         원<br />
         </b>
         <b>
         [
   ...
   <tr bgcolor="#efefef">
      ...
      <fmt:formatNumber value="${totalBuy+deliverCost}" pattern="###,###" />
      </h2>원<br />
...
<input type="hidden" name="odeliverCost" value="3000">
            ...
            <th scope="row" width="150px">사용가능 적립금</th>
                ...
                <p> 
                   ...
                   size="10" oninput="checkPoint(this,'${mileage }')" >
                    원 (사용가능 적립금 :<span style="color:red;font-weight:bold">
                    <fmt:formatNumber value="${mileage}"  pattern="###,###"/>
                       원
                    </span> 
...
<table class="table table-bordered">
   ...
   <tr>
      <td><b>수령자</b></td>
      <td class="text-left">
         <input type="text" name="rcvname" value="${loginUser.name}">
      </td>
   </tr>
   <tr>
      <td><b>연락처</b></td>
   ...
   <tr>
      ...
      <td class="text-left">
      <div class="col-md-3">
      <input type="text" name="zipcode" value="${loginUser.zipcode}" class="form-control"  maxlength="5" /> 
      </div>
